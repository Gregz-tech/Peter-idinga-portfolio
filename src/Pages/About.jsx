    ...
    >
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          {/* TO DO: Replace 'Photo.jpg' in your public folder with your own image, or use a Memoji */}
          <img
            src="/Photo.jpg"
            alt="Profile"
  ...
  const statsData = [
    {
      ...
      value: "4+", // Hardcoded based on your projects (Vireo, QPrep, Tectrax, etc.)
    ...
    },
    {
      ...
      description: "Web Dev, Bioinformatics, UI/UX",
      animation: "fade-up",
    },
    {
      icon: Globe,
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I am a Junior Web Developer and a student in the Department of <b>Information Technology & Health Informatics (ITH)</b> at FUHSI.
             <br /><br />
             My work sits at the intersection of healthcare and technology. From leading the <b>FUHSI Staff Data Digitization</b> team to building scalable applications with <b>Node.js</b> and <b>C++</b>, I am focused on solving real-world problems through efficient code and intuitive design.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Writing clean code to bridge the gap between complex data and human experience."
              </blockquote>
            </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              {/* CV BUTTON - Replace href with your actual Google Drive or PDF link */}
