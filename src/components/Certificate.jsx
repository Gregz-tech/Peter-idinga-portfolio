...
const Certificate = ({ ImgSertif }) => {
    ...
    // Helper to ensure image path works (forces / at start if missing)
    const imgSource = ImgSertif.startsWith('http') || ImgSertif.startsWith('/') 
        ? ImgSertif 
        : `/${ImgSertif}`;
        ...
        <Box component="div" sx={{ width: "100%" }}>
            ...
            <Modal
                ...
                BackdropProps={{
                    timeout: 500,
                    sx: {
                        backgroundColor: "rgba(0, 0, 0, 0.9)", // Deep dark backdrop
